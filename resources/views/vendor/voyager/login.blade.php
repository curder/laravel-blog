...
<head>
    ...
    <style>
        body {
            ...
            background-color: {{ Voyager::setting("admin_bg_color", "#fff" ) }};
        }
        .login-sidebar:after {
            background: linear-gradient(-135deg, {{config('voyager.login.gradient_a','#fff')}}, {{config('voyager.login.gradient_b','#ffffff')}});
            background: -webkit-linear-gradient(-135deg, {{config('voyager.login.gradient_a','#fff')}}, {{config('voyager.login.gradient_b','#ffffff')}});
        }
    ...
    <div class="row">
                ...
                <div class="col-sm-12 col-md-10 col-md-offset-2">
                    <div class="logo-title-container">
                        ...
                        <div class="copy animated fadeIn">
                            <h1>{{ Voyager::setting('admin_title', 'A person who is lonely.') }}</h1>
                            <p>@lang('voyager.login.welcome') </p>
                        </div>
        ...
        <div class="col-xs-12 col-sm-4 col-md-3 login-sidebar animated fadeInRightBig">
            ...
            <div class="login-container animated fadeInRightBig">
                ...
                <h2>@lang('voyager.login.signin_below')</h2>
                ...
                <div class="group">
                  ...
                  <span class="bar"></span>
                  <label><i class="glyphicon glyphicon-user"></i><span class="span-input">@lang('voyager.generic.email')</span></label>
                </div>
                ...
                <div class="group">
                  ...
                  <span class="highlight"></span>
                  <span class="bar"></span>
                  <label><i class="glyphicon glyphicon-lock"></i><span class="span-input"> @lang('voyager.generic.password')</span></label>
                </div>

                <button type="submit" class="btn btn-block login-button">
                    <span class="signingin hidden"><span class="glyphicon glyphicon-refresh"></span> @lang('voyager.login.loginin')</span>
                    <span class="signin">@lang('voyager.generic.login')</span>
                </button>
